...
export default function Header() {
  ...
  return (
    <header className="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 px-6 py-4" data-tour="header">
        ...
        <div className="flex items-center space-x-4">
          ...
          {user && isSuperAdmin(user) && (
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 bg-accent text-white rounded-lg hover:bg-accent hover:shadow-lg transition-all"
          ...
          <button
            ...
            className="p-2 rounded-md hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-600 dark:text-slate-300 transition-colors"
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-2 p-2 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-md transition-colors"
            >
